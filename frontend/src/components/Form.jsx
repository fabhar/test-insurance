...
const Form = ({setResume, setLoading}) => {
    ...
    const initBrands = [{ id: 1, value: 'Proton Saga'}, { id: 2, value: 'Proton X70'}, { id: 3, value: 'Proton Persona'}, 
        { id: 4, value: 'Toyota Camry'}, { id: 5, value: 'Toyota Vios'}, { id: 6, value: 'Nissan Almera'}, { id: 7, value: 'Nissan Leaf'}];
        ...
        >
            ...
            <Field>
                ...
                <Select
                    ...
                    onChange={getData}
                >
                    <option value="">-- Select Car Year Make --</option>
